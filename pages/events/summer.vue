<template>
	<div>
		<TheJumbotron :title="'Summer events'" :description="'great summer events in town to enter and enjoy.'" />
		<select class="form-select mb-4" aria-label="Default select example" @change="goToSeasonEventPage($event)">
			...
			<option value="/events/summer" selected>Summer Events</option>
			<option value="/events/winter">Winter Events</option>
		</select>
